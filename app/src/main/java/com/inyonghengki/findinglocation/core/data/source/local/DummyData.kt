package com.inyonghengki.findinglocation.core.data.source.local
...
object DummyData {
    ...
    val listSlider = listOf(
        Slider(id = 1, name = "Slider1", imageDummy = R.drawable.assetdua),
        Slider(id = 2, name = "Slider2", imageDummy = R.drawable.assettiga),
        Slider(id = 3, name = "Slider3", imageDummy = R.drawable.butuh_bantuan),
    )
