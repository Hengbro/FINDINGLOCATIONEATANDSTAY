...
import com.inyonghengki.findinglocation.ui.categoryproduct.adapter.SelectCategoryProductAdapter
...
class SelectCategoryProductActivity : MyActivity() {
    ...
    private var adapter = SelectCategoryProductAdapter(
        onClick = {
            val intent = Intent()
