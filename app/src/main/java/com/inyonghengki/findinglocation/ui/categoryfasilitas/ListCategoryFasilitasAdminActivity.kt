...
import com.inyonghengki.findinglocation.ui.categoryfasilitas.adapter.CategoryFasilitasAdminAdapter
...
class ListCategoryFasilitasAdminActivity : MyActivity() {

    private val viewModel : CategotryFasilitaAdminViewModel by viewModel()
    private var adapter = CategoryFasilitasAdminAdapter (
        onClick = {
            intentActivity(AddCategoryFasilitasAdminActivity::class.java,it)
    },
    ...
    private fun confirmDelete(item: CategoryFasilitas, pos: Int){
        showConfirmDialog(
            "Hapus Kategori",
    ...
    private fun onDelete(item: CategoryFasilitas, pos: Int){
    ...
    private fun mainButton(){
        ...
        binding.apply {
            btnAddcategory.setOnClickListener {
                intentActivity(AddCategoryFasilitasAdminActivity::class.java)
            }
        }
