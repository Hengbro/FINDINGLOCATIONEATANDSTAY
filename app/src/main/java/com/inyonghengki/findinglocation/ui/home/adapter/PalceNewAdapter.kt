...
class PalceNewAdapter (

    val onClick:(item: Tempat) -> Unit

) : RecyclerView.Adapter<PalceNewAdapter.ViewHolder>(){

    private var data = ArrayList<Tempat>()

    inner class ViewHolder(private val itemBinding: ItemNewtempatBinding): RecyclerView.ViewHolder(itemBinding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemNewtempatBinding.inflate(
