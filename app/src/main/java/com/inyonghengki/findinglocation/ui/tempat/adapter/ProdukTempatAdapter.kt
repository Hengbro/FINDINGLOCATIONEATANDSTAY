...
import com.inyonghengki.findinglocation.databinding.ItemDetailprodukBinding
...
class ProdukTempatAdapter : RecyclerView.Adapter<ProdukTempatAdapter.ViewHolder>(){

    private var data = ArrayList<MenuProduct>()

    inner class ViewHolder(private val itemBinding: ItemDetailprodukBinding): RecyclerView.ViewHolder(itemBinding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemDetailprodukBinding.inflate(
