...
import com.inyonghengki.findinglocation.ui.category.adapter.CategoryAdminAdapter
...
class ListCategoryAdminActivity : MyActivity() {
    ...
    private var adapter = CategoryAdminAdapter (
        onClick = {
            intentActivity(AddCategoryAdminActivity::class.java,it)
    },
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setToolbar(binding.toolbar, "List Kategori")
    ...
    private fun mainButton(){
        ...
        binding.apply {
            btnAddcategory.setOnClickListener {
                intentActivity(AddCategoryAdminActivity::class.java)
            }
        }
