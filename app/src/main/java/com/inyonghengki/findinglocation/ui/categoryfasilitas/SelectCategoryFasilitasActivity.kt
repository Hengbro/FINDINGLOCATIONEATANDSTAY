...
import com.inyonghengki.findinglocation.ui.categoryfasilitas.adapter.SelectCategoryFasilitasAdapter
...
class SelectCategoryFasilitasActivity : MyActivity() {
    ...
    private var adapter = SelectCategoryFasilitasAdapter(
        onClick = {
            val intent = Intent()
